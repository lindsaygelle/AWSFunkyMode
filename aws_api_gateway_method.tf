...
resource "aws_api_gateway_method" "console_post" {
  api_key_required     = false
  authorization        = "NONE"
  authorization_scopes = []
  http_method          = "POST"
...
resource "aws_api_gateway_method" "entity_post" {
  api_key_required     = false
  authorization        = "NONE"
  authorization_scopes = []
  http_method          = "POST"
...
resource "aws_api_gateway_method" "game_post" {
  api_key_required     = false
  authorization        = "NONE"
  authorization_scopes = []
  http_method          = "POST"
...
resource "aws_api_gateway_method" "key_phrase_post" {
  api_key_required     = false
  authorization        = "NONE"
  authorization_scopes = []
  http_method          = "POST"
...
resource "aws_api_gateway_method" "pii_post" {
  api_key_required     = false
  authorization        = "NONE"
  authorization_scopes = []
  http_method          = "POST"
...
resource "aws_api_gateway_method" "quote_post" {
  api_key_required     = false
  authorization        = "NONE"
  authorization_scopes = []
  http_method          = "POST"
...
resource "aws_api_gateway_method" "quote_subscription_post" {
  api_key_required     = false
  authorization        = "NONE"
  authorization_scopes = []
  http_method          = "POST"
...
resource "aws_api_gateway_method" "quote_subscription_rule_post" {
  api_key_required     = false
  authorization        = "NONE"
  authorization_scopes = []
  http_method          = "POST"
...
resource "aws_api_gateway_method" "sentiment_score_post" {
  api_key_required     = false
  authorization        = "NONE"
  authorization_scopes = []
  http_method          = "POST"
...
resource "aws_api_gateway_method" "syntax_token_part_of_speech_post" {
  api_key_required     = false
  authorization        = "NONE"
  authorization_scopes = []
  http_method          = "POST"
...
resource "aws_api_gateway_method" "syntax_token_post" {
  api_key_required     = false
  authorization        = "NONE"
  authorization_scopes = []
  http_method          = "POST"
