...
data "archive_file" "api_gateway_main_console_post_integration" {
  output_path = "./src/api_gateway/main/console/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/console/integration/POST/lambda_function/src"
  type        = "zip"
}
...
data "archive_file" "api_gateway_main_entity_post_integration" {
  output_path = "./src/api_gateway/main/entity/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/entity/integration/POST/lambda_function/src"
  type        = "zip"
}
...
data "archive_file" "api_gateway_main_game_post_integration" {
  output_path = "./src/api_gateway/main/game/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/game/integration/POST/lambda_function/src"
  type        = "zip"
}
...
data "archive_file" "api_gateway_main_key_phrase_post_integration" {
  output_path = "./src/api_gateway/main/key_phrase/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/key_phrase/integration/POST/lambda_function/src"
  type        = "zip"
}
...
data "archive_file" "api_gateway_main_pii_post_integration" {
  output_path = "./src/api_gateway/main/pii/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/pii/integration/POST/lambda_function/src"
  type        = "zip"
}
...
data "archive_file" "api_gateway_main_quote_post_integration" {
  output_path = "./src/api_gateway/main/quote/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/quote/integration/POST/lambda_function/src"
  type        = "zip"
}
...
data "archive_file" "api_gateway_main_quote_subscription_post_integration" {
  output_path = "./src/api_gateway/main/quote_subscription/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/quote_subscription/integration/POST/lambda_function/src"
  type        = "zip"
}
...
data "archive_file" "api_gateway_main_quote_subscription_rule_post_integration" {
  output_path = "./src/api_gateway/main/quote_subscription_rule/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/quote_subscription_rule/integration/POST/lambda_function/src"
  type        = "zip"
}
...
data "archive_file" "api_gateway_main_sentiment_post_integration" {
  output_path = "./src/api_gateway/main/sentiment/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/sentiment/integration/POST/lambda_function/src"
  type        = "zip"
}
...
data "archive_file" "api_gateway_main_sentiment_score_post_integration" {
  output_path = "./src/api_gateway/main/sentiment_score/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/sentiment_score/integration/POST/lambda_function/src"
  type        = "zip"
}
...
data "archive_file" "api_gateway_main_syntax_token_part_of_speech_post_integration" {
  output_path = "./src/api_gateway/main/syntax_token_part_of_speech/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/syntax_token_part_of_speech/integration/POST/lambda_function/src"
  type        = "zip"
}

data "archive_file" "api_gateway_main_syntax_token_post_integration" {
  output_path = "./src/api_gateway/main/syntax_token/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/syntax_token/integration/POST/lambda_function/src"
  type        = "zip"
}
...
data "archive_file" "api_gateway_main_user_post_integration" {
  output_path = "./src/api_gateway/main/user/integration/POST/lambda_function/file.zip"
  source_dir  = "./src/api_gateway/main/user/integration/POST/lambda_function/src"
  type        = "zip"
}
